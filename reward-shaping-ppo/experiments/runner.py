...
class ExperimentRunner:
    ...
    def _create_directories(self, seed: int) -> Dict[str, str]:
        ...
        paths = {
            "model_dir": os.path.abspath(os.path.join(self.base_dir, "models", self.env_id, self.strategy, seed_suffix)),
            "log_dir": os.path.abspath(os.path.join(self.base_dir, "logs", self.env_id, self.strategy, seed_suffix)),
            "result_dir": os.path.abspath(os.path.join(self.base_dir, "results", self.env_id, self.strategy, seed_suffix))
        }
