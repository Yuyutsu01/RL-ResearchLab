...
- The PPO agent successfully converged to the absolute ceiling performance of **240.78** across all seeds.
- Variance at convergence is **zero** (SD: 21.89, 95% CI: ± 16.51).
- Mean training runtime on CPU is **1780.81 seconds**.
